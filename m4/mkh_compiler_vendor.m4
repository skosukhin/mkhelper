...
# version of the list _MKH_COMPILER_KNOWN_VENDORS. If the vendor sets
...
# MKH_COMPILER_*_VENDOR_SIMPLE macros.

# MKH_COMPILER_FC_VENDOR()
# -----------------------------------------------------------------------------
...
# supported.
#
m4_define([_MKH_COMPILER_KNOWN_VENDORS],
  [m4_ifdef([$0(]_AC_LANG[)],
     [m4_indir([$0(]_AC_LANG[)], $@)],
     [m4_fatal([the list of ]_AC_LANG[ compiler vendors is undefined])])])

# _MKH_COMPILER_KNOWN_VENDORS(Fortran)()
# -----------------------------------------------------------------------------
# Implementation of _MKH_COMPILER_KNOWN_VENDORS for Fortran language.
#
m4_define([_MKH_COMPILER_KNOWN_VENDORS(Fortran)],
...
# _MKH_COMPILER_KNOWN_VENDORS(C)()
# -----------------------------------------------------------------------------
# Implementation of _MKH_COMPILER_KNOWN_VENDORS for C language.
#
m4_define([_MKH_COMPILER_KNOWN_VENDORS(C)],
...
# Implementation of _MKH_COMPILER_KNOWN_VENDORS for C++ language.
#
m4_copy([_MKH_COMPILER_KNOWN_VENDORS(C)], [_MKH_COMPILER_KNOWN_VENDORS(C++)])
