...
AC_DEFUN([ACX_FC_MOD_IN_FLAG],
  [AC_REQUIRE([AC_PROG_FC])
   AC_CACHE_CHECK([for Fortran flag to specify module search paths], [acx_cv_fc_mod_in_flag],
   ...
   AS_IF([test x"$acx_cv_fc_mod_in_flag" != xunknown],
     ...
     [m4_default(
        [$2],
        [AC_MSG_FAILURE([unable to detect flag needed specify module search paths])])])])
